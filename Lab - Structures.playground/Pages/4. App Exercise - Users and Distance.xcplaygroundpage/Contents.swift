...
var myOwn = User(name: "Sergey", age: 38, height: 182, weight: 79.9, activityLevel: 8)
print(myOwn.name, myOwn.age, myOwn.height, myOwn.weight, myOwn.activityLevel)
/*:
...
var newDistance = Distance(feet: 5249)
