...
let newRectangle = Rectangle(width: 54, height: 78)
    ...
    var heightInInches: Double {
        didSet {
            if heightInCentimeters != heightInInches * 2.54 {
                ...
                print("Height inches equals \(heightInInches) and height in in centimeters equals \(heightInCentimeters).")
            }
        }
    }
    var heightInCentimeters: Double {
        didSet {
            if heightInInches != heightInCentimeters / 2.54 {
                ...
                print("Height in centimeters equals \(heightInCentimeters) and height in inches equals \(heightInInches).")
            }
        }
    }
...
var newHeight = Height(heightInCentimeters: 100)
newHeight.heightInCentimeters = 129
newHeight.heightInInches = 55
