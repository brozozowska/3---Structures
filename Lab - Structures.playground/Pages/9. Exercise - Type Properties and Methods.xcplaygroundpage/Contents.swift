...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser = User(userName: "brozozowska", email: "s_rozov@me.com", age: 38)
 ...
 */
let user1 = User(userName: "user1", email: "user1@mail.ru", age: 19)
let user2 = User(userName: "user2", email: "user2@mail.ru", age: 25)
