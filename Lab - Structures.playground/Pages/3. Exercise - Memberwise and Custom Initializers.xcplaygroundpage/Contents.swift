...
var favoriteBook = Book(title: "Благоволительницы", author: "Джоннатан Литтл", pages: 567, price: 2999.99)
print(favoriteBook.title, favoriteBook.author, favoriteBook.pages)
/*:
...
let laptop2 = Laptop(screenSize: 15, repairCount: 1, yearPurchased: 2013)
/*:
...
print(someHeight.heightInInches, someHeight.heightInCentimeters)
